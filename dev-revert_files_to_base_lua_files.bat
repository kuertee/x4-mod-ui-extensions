...
set "SOURCE=..\base 9.0 rc 3\ui\addons\ego_detailmonitor"
...
set "SOURCE=..\base 9.0 rc 3\ui\addons\ego_detailmonitorhelper"
set "DEST=%~dp0\ui\addons\ego_detailmonitorhelper"
copy "%SOURCE%\helper.lua" "%DEST%\helper.xpl"

set "SOURCE=..\base 9.0 rc 3\ui\addons\ego_gameoptions"
...
set "SOURCE=..\base 9.0 rc 3\ui\addons\ego_interactmenu"
